            ...
            <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="inline-flex items-center justify-center bg-white hover:bg-blue-50 text-blue-700 border border-blue-600 px-10 h-12 text-base font-semibold rounded-md no-underline"
                >
                  📄 詳細資料はこちら
                </a>
