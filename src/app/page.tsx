      ...
      <section className="py-24 bg-background">
        <div className="container">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              環境に配慮しながら、ビジネスの効率化とコスト削減を実現する2つの革新的な製品をご紹介します。
            </p>
          </MotionDiv>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <MotionDiv initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <div className="overflow-hidden border border-border/50 shadow-lg hover:shadow-xl transition-all h-full rounded-lg">
                <div className="h-52 bg-gradient-to-br from-emerald-50 to-emerald-100 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <TreePine className="w-16 h-16 text-emerald-600/40" />
                    <span className="text-xs font-medium tracking-wider uppercase text-emerald-600/60">Eco-Friendly Pallet</span>
                  </div>
                </div>
                <div className="p-8">
                  <span className="px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 text-xs font-medium">環境配慮型パレット</span>
                  <h3 className="text-2xl font-bold text-foreground mb-3 mt-4">RECOPALLET</h3>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    ベトナム産のココナツヤシ殻を100%使用した、森林破壊ゼロの環境配慮型物流パレット。高い強度と耐久性を備えながら、カーボンニュートラルに貢献します。
                  </p>
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    <div className="text-center p-3 bg-secondary/50 rounded-lg">
                      <p className="text-lg font-bold text-foreground">3トン</p>
                      <p className="text-xs text-muted-foreground">静荷重</p>
                    </div>
                    <div className="text-center p-3 bg-secondary/50 rounded-lg">
                      <p className="text-lg font-bold text-foreground">17kg</p>
            ...
            <MotionDiv initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <div className="overflow-hidden border border-border/50 shadow-lg hover:shadow-xl transition-all h-full rounded-lg">
                <div className="h-52 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <Zap className="w-16 h-16 text-blue-600/40" />
                    <span className="text-xs font-medium tracking-wider uppercase text-blue-600/60">Energy Saving Filter</span>
                  </div>
                </div>
                <div className="p-8">
                  <span className="px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-xs font-medium">省エネフィルター</span>
                  <h3 className="text-2xl font-bold text-foreground mb-3 mt-4">CONTINEWM</h3>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="text-center p-3 bg-secondary/50 rounded-lg">
                      <p className="text-lg font-bold text-foreground">特許</p>
                  ...
                  <Link href="/products/continewm" className="flex items-center justify-center w-full bg-primary hover:bg-primary/90 text-primary-foreground py-3 rounded-md font-medium transition-colors no-underline">
                    詳しく見る <ArrowRight className="ml-2 w-4 h-4" />
                  </Link>
                </div>
              </div>
